      ...
      <div className="footer">
        <div className="footer__block">
          ...
          <span className="footer__legal">
            ...
            <div>Audax Explorer &copy; 2018 - {currentYear} <a href="https://audaxproject.io/" target="_blank" rel="nofollow noopener">Audax Digital Currency</a></div>
          </span>
        </div>
        <div className="footer__block">
        ...
        <div className="footer__block">
          <div className="footer__social-media-wrapper">
            ...
            <div>
              ...
              <a href="https://reddit.com/u/Audaxcoin" target="_blank" rel="nofollow noopener">
                <Icon name="reddit" className="fab footer__social-media-icon" />
              </a>
              <a href="https://github.com/theaudaxproject/audax" target="_blank" rel="nofollow noopener">
